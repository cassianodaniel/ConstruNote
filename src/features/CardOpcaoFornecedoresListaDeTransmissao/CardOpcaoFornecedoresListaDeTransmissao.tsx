  ...
  return (
    <div className="mainContainerFavoritos transmissao shadow m-4">
      ...
      <div className="searchFavorite">
        ...
        <div className="font-size-18">Inclua até 20 fornecedores na lista de transmissão da sua cotação. Use a barra de busca para encontrar fornecedores que já são membros da nossa comunidade.</div>
